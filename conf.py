...
BLOG_AUTHOR = "Gregory Newman"  # (translatable)
BLOG_TITLE = "bozos live here"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://bozoslivehere.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://bozoslivehere.github.io/"
BLOG_EMAIL = "gregory.e.newman@gmail.com"
BLOG_DESCRIPTION = "blog about code, linux, emacs, mexico, and whatever else"  # (translatable)
